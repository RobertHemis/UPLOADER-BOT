...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @alifano02bot"
...
If bot didn't respond, contact @abeseil"""
...
"""
    ...
    SLOW_URL_DECED = "Gosh that seems to be a very slow URL. Since you were screwing my home, I am in no mood to download this file. Meanwhile, why don't you try this:==> aurl.extension and get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
